...
const AboutSection = () => {
  ...
  return (
    <section
      id="about"
      className="min-h-screen flex items-center py-4 px-4 bg-transparent"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-lg text-slate-600 mb-6 leading-relaxed dark:text-slate-200">
            ...
            <div className="flex gap-4">
              {stats.map((item, index) => (
                <article key={index} className="text-center">
                  <h3 className="text-3xl font-bold text-emerald-600 dark:text-emerald-300">
                    {item.value}
                  </h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            {
              ...
              skillsCards.map(({ name, icon: Icon, desc }, index) => (
                <article
                  key={index}
                  className="bg-white/80 backdrop-blur-sm p-6 rounded-lg hover:bg-white transition-all shadow-sm dark:bg-slate-800/70 dark:hover:bg-slate-800 dark:border dark:border-slate-700/70"
                >
                  <Icon className="w-12 h-12 text-emerald-600 mb-4 dark:text-emerald-300" />
